<?php   // Apagar um cliente do banco de dados e mandar confirmação para o frontend; 
    ...
    if(isset($_GET['id'])){
        // Caso seja fornecido o ID por GET
        $stmt = $conexao->prepare("DELETE FROM tutorial WHERE id = ?");

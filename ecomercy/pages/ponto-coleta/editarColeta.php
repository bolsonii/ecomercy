...
<body>
                ...
                <div class="col-12 col-md-8 offset-md-2">
                    <div class="user-loja-card card-loja coleta-card p-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h2 class="card-titulo mb-0">Alterar Ponto de Coleta</h2>
                        </div>

                        <form id="formEditarColeta">
                            <input type="hidden" id="idColeta">

                            <div class="mb-3">
                                <label for="novoEndereco" class="form-label">Endereço</label>
                                <input type="text" id="novoEndereco" name="endereco" class="form-control" />
                            </div>

                            <div class="mb-3">
                                <label for="novoHora" class="form-label">Horário</label>
                                <input type="time" id="novoHora" name="hora" class="form-control" />
                            </div>

                            <div class="mb-3">
                                <label for="novoLoja" class="form-label">Nome da loja</label>
                                <input type="text" id="novoLoja" name="loja" class="form-control" />
                            </div>

                            <div class="d-flex justify-content-end">
                                <button type="button" id="editarColeta" class="btn btn-success">Salvar alterações</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script src="../../js/ponto-coleta/editarColeta.js"></script>
</body>
</html>
